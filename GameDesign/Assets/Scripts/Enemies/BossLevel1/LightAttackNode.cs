...
public class LightAttackNode : BTNode
{
    ...
    public LightAttackNode(Transform boss, Transform player, Animator animator, string animationTrigger, float cooldown, float attackDuration, float damage, float knockbackForce, LayerMask playerLayer, float attackRange, float damageFrameRatio = 3f / 7f)
    {
        this.boss = boss;
        this.player = player;
